...
@Component({
  selector: 'nc-web-public-news-view',
  templateUrl: './public-news-view.component.html',
  styleUrl: './public-news-view.component.scss'
})
export class PublicNewsViewComponent implements OnInit, AfterViewInit {
  ...
  constructor(private elRef: ElementRef, private renderer: Renderer2, private appService: AppServiceService, public metaShareService: MetaServiceService, private alertService: AlertService, private route: ActivatedRoute,
